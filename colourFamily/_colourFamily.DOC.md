...
This program will list details for named families\. You can either give a
comma\-separated list of family names and it will just give details for those
or, if no families are provided, all families will be listed\.
